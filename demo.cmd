...
.\target\debug\rhp.exe pack ^
  ...
  --code-path .\target\debug\transform_lattice_scope_cache_lookup.dll ^
...
.\target\debug\rhp.exe pack ^
  ...
  --code-path .\target\debug\transform_net_send_flux_batch.dll ^
...
.\target\debug\rhp.exe pack ^
  ...
  --code-path .\target\debug\transform_net_send_flux_fire.dll ^
...
.\target\debug\rhp.exe pack ^
  ...
  --code-path .\target\debug\transform_crypto_ed25519_generate.dll ^
...
.\target\debug\rhp.exe pack ^
  ...
  --code-path .\target\debug\hpc_net_send_flux.dll ^
...
.\target\debug\rhp.exe pack ^
  ...
  --code-path .\target\debug\hpc_crypto_ed25519_generate.dll ^
